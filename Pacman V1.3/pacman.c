...
void fantasma(int x, int y, int color);  //funcion que genera un fantasma
...
void fantasma(int x, int y, int color)  //Funcion que imprime el fantasma en la pantalla
{
    int radx = 10;
    ...
    setfillstyle(1, color);
    arc(x, y, 0, 180, radx);
    line(x+radx, y, x+radx, y+radx*2);  //Cuerpo del fantasma
    ...
    fillellipse(x+radx/2, y, radx/6, radx/4);  //ojos del fantasma
...
void MovePacman()
{
    ...
    int iOp, iCorxU=50, iCorxF=50, iCoryU=50, iCoryF=50;
    //interfaz();
